...
figure, plot(digit_1);title('Digit\_1 chosen for experiment'),xlabel('Samples'),ylabel('Amplitude');
...
figure, plot(SelectedFrames(:,1)), title('Frame-4 of digit-1');xlabel('Samples'),ylabel('Amplitude');
figure, plot(SelectedFrames(:,2)), title('Frame-5 of digit-1');xlabel('Samples'),ylabel('Amplitude');
figure, plot(SelectedFrames(:,3)), title('Frame-6 of digit-1');xlabel('Samples'),ylabel('Amplitude');
figure, plot(SelectedFrames(:,4)), title('Frame-7 of digit-1');xlabel('Samples'),ylabel('Amplitude');

%% Mimicking LPC-10: Obtain the parameter values that are computed (and transmitted after quantization) by the LPC-l0 vocoder. Note that there is no need to quantize the parameters.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% For Frame-4
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ylabel('Log-Magnitude in dB of Frame 4 of digit one');
title('Log-Magnitude in dB & LSFs of Frame 4 of digit one');
...
% For Frame-5
P=10;
RMS=sqrt(mean(sum(SelectedFrames(:,2).^2))); 
[Coefficents,Var]=lpc(SelectedFrames(:,2),P); % LPC Coefficients
k = poly2rc(Coefficents); % Reflection Coefficients
...
figure,zplane(Pz,Qz);legend('Roots of P(Z)','Roots of Q(Z)');title('Roots of P(z) & Q(z) of digit one Frame 5');
...
stem(LSF_hz,value_lsf,'k');
xlabel('Frequency in Hz');
ylabel('Log-Magnitude in dB of Frame 5 of digit one');
title('Log-Magnitude in dB & LSFs of Frame 5 of digit one');

%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% For Frame-6
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
temp = digit_1(6*180+1:10*180); % For frames-4,5,6,7
% Delays for Avg Mag Diff Fun
t1=linspace(20,39,20);
t2=linspace(40,78,20);
t3=linspace(80,156,20);
...
% For Frame-6
P=10;
RMS=sqrt(mean(sum(SelectedFrames(:,3).^2))); 
[Coefficents,Var]=lpc(SelectedFrames(:,3),P); % LPC Coefficients
k = poly2rc(Coefficents); % Reflection Coefficients
...
figure,zplane(Pz,Qz);legend('Roots of P(Z)','Roots of Q(Z)');title('Roots of P(z) & Q(z) of digit one Frame 6');
...
stem(LSF_hz,value_lsf,'k');
xlabel('Frequency in Hz');
ylabel('Log-Magnitude in dB of Frame 6 of digit one');
title('Log-Magnitude in dB & LSFs of Frame 6 of digit one');

%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% For Frame-7
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
temp = digit_1(7*180+1:11*180); % For frames-4,5,6,7
% Delays for Avg Mag Diff Fun
t1=linspace(20,39,20);
t2=linspace(40,78,20);
t3=linspace(80,156,20);
...
% For Frame-7
P=10;
RMS=sqrt(mean(sum(SelectedFrames(:,4).^2))); 
[Coefficents,Var]=lpc(SelectedFrames(:,4),P); % LPC Coefficients
k = poly2rc(Coefficents); % Reflection Coefficients
...
figure,zplane(Pz,Qz);legend('Roots of P(Z)','Roots of Q(Z)');title('Roots of P(z) & Q(z) of digit one Frame 7');
...
stem(LSF_hz,value_lsf,'k');
xlabel('Frequency in Hz');
ylabel('Log-Magnitude in dB of Frame 7 of digit one');
title('Log-Magnitude in dB & LSFs of Frame 7 of digit one');